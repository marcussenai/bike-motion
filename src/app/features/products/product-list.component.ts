        ...
        @for (bike of bikeService.getBikes(); track bike.id) {
          ...
          <div class="product-card">
            ...
            <div class="card-body">
              ...
              <div class="price-row">
                <span class="price">R$ {{ bike.price.toFixed(2) }}</span>
              ...
              <div class="card-actions">
                ...
                @if (remaining > 0) {
                  <button (click)="addToCart(bike)" class="btn-buy">
                    Comprar
                  </button>
                } @else {
...
export class ProductListComponent {
  ...
  getAvailableStock(bike: Bike): number {
    ...
    const cartItem = cartItems.find((item: any) => item.bike.id === bike.id);
  ...
  onImgError(event: Event) {
    ...
    imgElement.src = 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=600&q=80';
  }
}